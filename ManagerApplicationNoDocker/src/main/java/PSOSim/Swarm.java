...
public class Swarm {
     ...
     */
    public Swarm (int particles, int epochs, int nodes, int workLoad, Vector currentWorkload, Node bestNode) {
    ...
    public Swarm (int particles, int epochs,int nodes, double inertia_max, double inertia_min, 
    													...
    													int workLoad, Vector currentWorkload, Node bestNode) {
        ...
        model = new Function(nodes,bestNode); //model 
    }
    ...
    private Particle[] initialize () {
        ...
        for (int i = 0; i < numOfParticles; i++) {
            ...
            double initialEval =  model.mainFunction(particle, workLoad, currentWorkload,bestNode).getSum();
    ...
    private double eval(Particle p){
    	double eval = model.mainFunction(p, workLoad, currentWorkload,bestNode).getSum();
    ...
    private static Map<Integer, Double> mappingRatio (Particle bestParticle, int workLoad){
